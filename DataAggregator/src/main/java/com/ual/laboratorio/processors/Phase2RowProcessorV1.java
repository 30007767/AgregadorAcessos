...
@Slf4j
@Component
public class Phase2RowProcessorV1 extends RowProcessor {
    ...
    public MediaAcesso getCourseAccess() throws ParseException {
        ...
        MediaAcesso acesso=null;
            ...
            Number number = format.parse(numberCorrection(row.get(9).getText()));
            acesso = MediaAcesso.builder()
                    ...
                    .vagasSobrantes(Integer.parseInt(numberCorrection(row.get(10).getText())))
                    .build();
        return acesso;
    }
